      ...
      <div className="section-wrap">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-base font-semibold text-white">
            Visit, call, or message us for bookings, decor inquiries, and full event planning support.
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4 rounded-2xl border border-white/20 bg-white/10 p-6">
            <p className="flex items-center gap-3"><Phone size={18} /> 0726 965 477 / 0723 066 340</p>
            <p className="flex items-center gap-3"><Mail size={18} /> bookings@victorsevents.co.ke</p>
            <p className="flex items-center gap-3"><MapPin size={18} /> Jerusalem Building, G04 & G05, Nakuru</p>
            <p className="text-sm text-white/90">P.O BOX 17448-20100</p>
